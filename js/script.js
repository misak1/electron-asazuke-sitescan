...
$(function () {
    ...
    var validation = function () {
        ...
        $.each($('[type="checkbox"]'), function (i, el) {
            setting[$(this).attr('value')] = $(this).prop('checked')
        });
    ...
    var loadCB = function (data) {
        ...
        if (data.verbose_log) {
            $('input[value="verbose_log"]').prop('checked', true);
        }
        if (data.captureing) {
            $('input[value="captureing"]').prop('checked', true);
        }
    }
